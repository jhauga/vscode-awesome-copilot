...
2. **Browse Categories**: User sees four expandable sections: Plugins, Instructions, Prompts, and Agents
...
1. **FR-01**: Explorer View Integration
   ...
   - **Acceptance Criteria**:
     ...
     - [ ] View shows four main categories: Plugins, Instructions, Prompts, and Agents
...
2. **FR-02**: Repository Data Fetching
   ...
   - **Acceptance Criteria**:
     - [ ] Extension fetches files from plugins/, instructions/, prompts/, and agents/ folders
...
5. **FR-05**: Download Functionality
   ...
   - **Acceptance Criteria**:
     ...
     - [ ] Plugins save to `.github/plugins/`
